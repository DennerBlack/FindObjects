...
X=101, Y=287
```
В этом примере точность куда хуже, чем в предыдущем. Это связано с тем, что размер датасета слишком мал. При увеличении обучающей выборки точность возрастет.
